...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        talkData.Add(1000, new string[] { "여어.:1", "이 호수는 정말 아름답지?:0", "사실 이 호수에는 엄청난 비밀이 숨겨져 있다고 해.:1" });
        ...
        talkData.Add(11 + 2000, new string[] { "아직 못 만났어?:0",
            "루도는 오른쪽 길을 따라가면 있어. :1", });
        talkData.Add(11 + 1000, new string[] { "여어.:0", 
            "호수의 전설을 들으러 온거야?:1", 
            "그럼 누가 일 좀 하나 해주면 좋을텐데...:0", 
            "내 집 근처에 떨어진 동전 좀 주워줬으면 해ㅎㅎ:1" });
